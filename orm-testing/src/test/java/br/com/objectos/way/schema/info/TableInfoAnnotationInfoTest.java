  ...
  public Object[][] tableGetCodeProvider() {
    return new Object[][] {
      { TableInfoAnnotationInfoFake.PAIR,
        "br.com.objectos.way.schema.it.PAIR PAIR = br.com.objectos.way.schema.it.PAIR.get();\n" },
      { TableInfoAnnotationInfoFake.REVISION,
        "br.com.objectos.way.schema.it.REVISION REVISION = br.com.objectos.way.schema.it.REVISION.get();\n" },
      { TableInfoAnnotationInfoFake.SALARY,
        "br.com.objectos.way.schema.it.SALARY SALARY = br.com.objectos.way.schema.it.SALARY.get();\n" }
    };
  }

...
import br.com.objectos.way.code.AbstractTestingProcessor;
...
class TestingProcessor extends AbstractTestingProcessor {
  ...
  private static class ProcessingEnvironmentWrapper extends br.com.objectos.way.code.ProcessingEnvironmentWrapper {

    private final Multimap<Class<?>, String> subTypeMap = ImmutableMultimap.<Class<?>, String> builder()
        .put(Insertable.class, "br.com.objectos.way.schema.it.Pair")
        .put(Insertable.class, "br.com.objectos.way.schema.it.Revision")
        .build();
